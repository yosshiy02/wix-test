...
$RoutesBefore = Join-Path $ProjectRoot "GPTが使う一時ファイルフォルダ\before\web_receiver\src\paymentDocuments\paymentDocuments.routes_before_invoice_title_priority_20260707_194355.js"
...
$MemoPath = Join-Path $MemoDir "00_payment_document_invoice_title_priority_undo_20260707_194355.txt"

$Out = @()
$Out += "=============================="
$Out += "支払書類AI 表題請求書最優先補正 UNDO結果"
$Out += "=============================="
