...
$BeforeHtml = Join-Path $TempRoot "before\web_receiver\public\payables\payable-list_before_left_small_font_20260706_213457.html"
$BeforeCss = Join-Path $TempRoot "before\web_receiver\public\payables\payable-list_before_left_small_font_20260706_213457.css"
...
Write-Host "OK: 請求書・未払管理の左側フォント小さめ調整をUNDOしました。"