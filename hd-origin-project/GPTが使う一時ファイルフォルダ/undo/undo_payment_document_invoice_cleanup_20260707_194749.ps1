...
$RoutesBefore = Join-Path $ProjectRoot "GPTが使う一時ファイルフォルダ\before\web_receiver\src\paymentDocuments\paymentDocuments.routes_before_invoice_cleanup_20260707_194749.js"
...
$MemoPath = Join-Path $MemoDir "00_payment_document_invoice_cleanup_undo_20260707_194749.txt"

$Out = @()
$Out += "=============================="
$Out += "支払書類AI 請求書補正後掃除 UNDO結果"
$Out += "=============================="
