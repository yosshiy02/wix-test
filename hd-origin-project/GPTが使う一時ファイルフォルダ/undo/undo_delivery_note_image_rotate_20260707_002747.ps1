...
$BeforeHtml = "G:\GITHUB\wix-test\hd-origin-project\GPTが使う一時ファイルフォルダ\before\delivery-note-inbox_before_image_rotate_20260707_002747.html"
...
Write-Host "OK: 納品書画像回転修正前に戻しました。"
