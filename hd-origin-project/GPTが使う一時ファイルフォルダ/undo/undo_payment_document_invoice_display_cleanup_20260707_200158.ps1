...
$RoutesBefore = Join-Path $ProjectRoot "GPTが使う一時ファイルフォルダ\before\web_receiver\src\paymentDocuments\paymentDocuments.routes_before_invoice_display_cleanup_20260707_200158.js"
...
$MemoPath = Join-Path $MemoDir "00_payment_document_invoice_display_cleanup_undo_20260707_200158.txt"

$Out = @()
$Out += "=============================="
$Out += "支払書類AI 請求書表示前クリーンアップ UNDO結果"
$Out += "=============================="
