...
$BeforeHtml = Join-Path $TempRoot "before\web_receiver\public\payables\payable-list_before_left_tiny_font_20260706_213655.html"
$BeforeCss = Join-Path $TempRoot "before\web_receiver\public\payables\payable-list_before_left_tiny_font_20260706_213655.css"
...
Write-Host "OK: 請求書・未払管理の左側フォント極小調整をUNDOしました。"