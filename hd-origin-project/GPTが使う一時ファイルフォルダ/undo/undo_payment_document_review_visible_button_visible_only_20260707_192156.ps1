...
$BeforePath = Join-Path $ProjectRoot "GPTが使う一時ファイルフォルダ\before\web_receiver\public\payables\payment-document-review_before_visible_button_visible_only_20260707_192156.html"
...
$MemoPath = Join-Path $MemoDir "00_payment_document_review_visible_button_visible_only_undo_20260707_192156.txt"

$Out = @()
$Out += "=============================="
$Out += "支払書類内容確認 表示ボタン 表示中項目限定 UNDO結果"
$Out += "=============================="
