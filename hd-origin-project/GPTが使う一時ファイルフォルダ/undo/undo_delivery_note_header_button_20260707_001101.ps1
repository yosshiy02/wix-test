...
$BeforeHtml = "G:\GITHUB\wix-test\hd-origin-project\GPTが使う一時ファイルフォルダ\before\payable-list_before_delivery_note_header_button_20260707_001101.html"
$BeforeRepo = "G:\GITHUB\wix-test\hd-origin-project\GPTが使う一時ファイルフォルダ\before\payables.repository_before_delivery_note_header_button_20260707_001101.js"
...
Write-Host "OK: 納品書ヘッダーボタン修正前に戻しました。"
