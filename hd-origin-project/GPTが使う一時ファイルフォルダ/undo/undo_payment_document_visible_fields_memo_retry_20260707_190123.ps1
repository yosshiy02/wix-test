...
$HtmlBefore = Join-Path $ProjectRoot "GPTが使う一時ファイルフォルダ\before\web_receiver\public\payables\payment-document-review_before_visible_fields_memo_retry_20260707_190123.html"
$CssBefore = Join-Path $ProjectRoot "GPTが使う一時ファイルフォルダ\before\web_receiver\public\payables\payment-document-review_before_visible_fields_memo_retry_20260707_190123.css"
$RoutesBefore = Join-Path $ProjectRoot "GPTが使う一時ファイルフォルダ\before\web_receiver\src\paymentDocuments\paymentDocuments.routes_before_visible_fields_memo_retry_20260707_190123.js"
...
$MemoPath = Join-Path $MemoDir "00_payment_document_visible_fields_memo_retry_undo_20260707_190123.txt"
