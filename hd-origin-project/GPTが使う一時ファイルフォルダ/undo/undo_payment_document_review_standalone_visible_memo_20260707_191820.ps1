...
$BeforePath = Join-Path $ProjectRoot "GPTが使う一時ファイルフォルダ\before\web_receiver\public\payables\payment-document-review_before_standalone_visible_memo_20260707_191820.html"
...
$MemoPath = Join-Path $MemoDir "00_payment_document_review_standalone_visible_memo_undo_20260707_191820.txt"

$Out = @()
$Out += "=============================="
$Out += "支払書類内容確認 表示ボタン独立化 UNDO結果"
$Out += "=============================="
