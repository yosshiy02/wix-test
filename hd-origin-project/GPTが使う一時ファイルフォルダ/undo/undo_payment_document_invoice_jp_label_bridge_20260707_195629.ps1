...
$RoutesBefore = Join-Path $ProjectRoot "GPTが使う一時ファイルフォルダ\before\web_receiver\src\paymentDocuments\paymentDocuments.routes_before_invoice_jp_label_bridge_20260707_195629.js"
...
$MemoPath = Join-Path $MemoDir "00_payment_document_invoice_jp_label_bridge_undo_20260707_195629.txt"

$Out = @()
$Out += "=============================="
$Out += "支払書類AI 請求書日本語ラベル反映 UNDO結果"
$Out += "=============================="
