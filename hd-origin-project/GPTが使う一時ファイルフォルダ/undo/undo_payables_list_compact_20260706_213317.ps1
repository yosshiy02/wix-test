...
$BeforeHtml = Join-Path $TempRoot "before\web_receiver\public\payables\payable-list_before_list_compact_20260706_213317.html"
$BeforeCss = Join-Path $TempRoot "before\web_receiver\public\payables\payable-list_before_list_compact_20260706_213317.css"
...
Write-Host "OK: 請求書・未払管理の左一覧コンパクト化をUNDOしました。"