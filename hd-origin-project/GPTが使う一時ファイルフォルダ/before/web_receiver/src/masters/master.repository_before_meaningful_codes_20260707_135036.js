...
const MASTER_DEFS = {
  account_titles: {
    ...
    extraColumns: ["account_code", "account_title_code"]
  },
  payment_methods: {
  ...
  target_people: {
    ...
    extraColumns: ["target_person_code"]
  },
  purposes: {
    type: "purposes",
    label: "目的",
