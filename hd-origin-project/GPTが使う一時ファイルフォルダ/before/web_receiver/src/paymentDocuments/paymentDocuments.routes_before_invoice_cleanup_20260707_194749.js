...
async function createTwoStepAiDraftFromOcrText(ocrText) {
  ...
  const classification = applyPaymentDocumentInvoiceTitlePriorityFromOcr(ocrText, applyPaymentDocumentRuleFallbackFromOcr(ocrText, normalizeAiDraftCandidate(classificationResponse.parsed)));
  ...
  const draft = applyPaymentDocumentInvoiceTitlePriorityFromOcr(ocrText, applyPaymentDocumentRuleFallbackFromOcr(ocrText, normalizeAiDraftCandidate(mergedRaw)));
