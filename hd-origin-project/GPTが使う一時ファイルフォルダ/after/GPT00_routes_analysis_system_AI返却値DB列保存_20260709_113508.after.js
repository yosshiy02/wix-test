...
function hdOriginBuildSortingDraftSavePayload(body, ocrRow) {
  ...
  /* HD_ORIGIN_SAVE_ANALYSIS_SYSTEM_FROM_AI_RESULT_GPT00_20260709_START */
  const sortResultForAnalysisSystem =
    body.sortResult && typeof body.sortResult === "object" ? body.sortResult :
    body.sort_result && typeof body.sort_result === "object" ? body.sort_result :
    body.sortResultJson && typeof body.sortResultJson === "object" ? body.sortResultJson :
    body.sort_result_json && typeof body.sort_result_json === "object" ? body.sort_result_json :
    root.sortResult && typeof root.sortResult === "object" ? root.sortResult :
    root.sort_result && typeof root.sort_result === "object" ? root.sort_result :
    draft.sortResult && typeof draft.sortResult === "object" ? draft.sortResult :
    draft.sort_result && typeof draft.sort_result === "object" ? draft.sort_result :
    {};

  const visibleFieldsForAnalysisSystem =
    body.visibleFields && typeof body.visibleFields === "object" ? body.visibleFields :
    body.visible_fields && typeof body.visible_fields === "object" ? body.visible_fields :
    body.visibleFieldsJson && typeof body.visibleFieldsJson === "object" ? body.visibleFieldsJson :
    body.visible_fields_json && typeof body.visible_fields_json === "object" ? body.visible_fields_json :
    root.visibleFields && typeof root.visibleFields === "object" ? root.visibleFields :
    root.visible_fields && typeof root.visible_fields === "object" ? root.visible_fields :
    draft.visibleFields && typeof draft.visibleFields === "object" ? draft.visibleFields :
    draft.visible_fields && typeof draft.visible_fields === "object" ? draft.visible_fields :
    {};
  /* HD_ORIGIN_SAVE_ANALYSIS_SYSTEM_FROM_AI_RESULT_GPT00_20260709_END */
  return {
    ...
    analysis_system_code: hdOriginSortingDraftText(body.analysisSystemCode || body.analysis_system_code || sortResultForAnalysisSystem.analysis_system_code || sortResultForAnalysisSystem.analysisSystemCode || visibleFieldsForAnalysisSystem.analysis_system_code || visibleFieldsForAnalysisSystem.analysisSystemCode || draft.analysis_system_code || root.analysis_system_code || aiSummary.analysis_system_code),
    analysis_system_label: hdOriginSortingDraftText(body.analysisSystemLabel || body.analysis_system_label || sortResultForAnalysisSystem.analysis_system_label || sortResultForAnalysisSystem.analysisSystemLabel || sortResultForAnalysisSystem.analysis_system || visibleFieldsForAnalysisSystem.analysis_system_label || visibleFieldsForAnalysisSystem.analysisSystemLabel || visibleFieldsForAnalysisSystem.analysis_system || draft.analysis_system_label || root.analysis_system_label || aiSummary.analysis_system_label || aiSummary.analysis_system),
    analysis_system_reason: hdOriginSortingDraftText(body.analysisSystemReason || body.analysis_system_reason || sortResultForAnalysisSystem.analysis_system_reason || sortResultForAnalysisSystem.analysisSystemReason || visibleFieldsForAnalysisSystem.analysis_system_reason || visibleFieldsForAnalysisSystem.analysisSystemReason || draft.analysis_system_reason || root.analysis_system_reason || aiSummary.analysis_system_reason),
    analysis_system_confidence: hdOriginSortingDraftText(body.analysisSystemConfidence || body.analysis_system_confidence || sortResultForAnalysisSystem.analysis_system_confidence || sortResultForAnalysisSystem.analysisSystemConfidence || visibleFieldsForAnalysisSystem.analysis_system_confidence || visibleFieldsForAnalysisSystem.analysisSystemConfidence || draft.analysis_system_confidence || root.analysis_system_confidence || aiSummary.analysis_system_confidence),
