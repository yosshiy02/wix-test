...
$AfterHtml = Join-Path $TempRoot "after\web_receiver\public\payables\payable-list_after_split_css_20260706_205252.html"
$AfterCss = Join-Path $TempRoot "after\web_receiver\public\payables\payable-list_after_split_css_20260706_205252.css"
...
Write-Host "OK: 請求書・未払管理画面のHTML/CSS分離を再反映しました。"