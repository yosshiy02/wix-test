...
Copy-Item `
    -LiteralPath "C:\Users\yossh.2FLABO\Desktop\新しいフォルダー\wix-test\hd-origin-project\GPTが使う一時ファイルフォルダ\after\GPT_restart_button_gitup_20260710_170142.after.server.js" `
...
if ($LASTEXITCODE -ne 0) {
    throw "APPLY後のserver.js構文確認に失敗しました。"
}
