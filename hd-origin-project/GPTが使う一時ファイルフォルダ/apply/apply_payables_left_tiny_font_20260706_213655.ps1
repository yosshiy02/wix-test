...
$AfterHtml = Join-Path $TempRoot "after\web_receiver\public\payables\payable-list_after_left_tiny_font_20260706_213655.html"
$AfterCss = Join-Path $TempRoot "after\web_receiver\public\payables\payable-list_after_left_tiny_font_20260706_213655.css"
...
Write-Host "OK: 請求書・未払管理の左側フォント極小調整を再反映しました。"