let items = [];
  ...
  function ocrLabel(item) {
    if (item.saveStatus === "saved" || item.savedStatus === "saved" || item.evidenceSaved || item.ocrSaved) return "保存済";
  ...
  function ocrClass(item) {
    if (item.saveStatus === "saved" || item.savedStatus === "saved" || item.evidenceSaved || item.ocrSaved) return "ocr-badge saved";
