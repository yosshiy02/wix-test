...
const out = "G:\\GITHUB\\wix-test\\hd-origin-project\\GPTが使う一時ファイルフォルダ\\memo\\payment_document_mojibake_check_v4_20260708_002729.txt";
...
(async () => {
  try {
    ...
    const sql = [
      ...
      "  LEFT(o.ocr_raw_text, 120) AS ocr_preview,",
    ...
    line("※ここが日本語なら psql/PowerShell 表示だけの問題");
    line("※ここも文字化けなら DB保存時点で文字化け");
    line("");
