...
(function () {
  ...
  function analysisResultOf(item) {
    ...
    return item.__analysisResult ||
      item.analysisResult ||
      item.analysis_result ||
      item.specialistAnalysis ||
      item.specialist_analysis ||
      item.analysis ||
      {};
  }
  ...
  function pushAiSummary(fields, section, draft, raw) {
    ...
    pushField(fields, section, "カード明細", "public_utility", draft.public_utility_label || summary.public_utility || "");
