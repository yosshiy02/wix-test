...
$HtmlPath = Join-Path $ProjectRoot "web_receiver\public\payables\payment-document-specialist-invoice-payable.html"
$BeforeHtml = Join-Path $BeforeDir "payment-document-specialist-invoice-payable.before_specialist_common_save_20260710_204842.html"
