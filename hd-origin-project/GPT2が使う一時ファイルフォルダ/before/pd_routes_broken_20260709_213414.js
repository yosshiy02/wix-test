...
async function hdOriginAnalyzeBusinessFlowWithOpenAi(sourceText) {
  ...
  const prompt = [
    ...
    "",
    "
【重要：支払・証憑情報が無くても対象外にしてはいけない情報】
次の内容は、支払明細や証憑情報が無くても、業務フロー設定の対象として扱う。
- 会社名
- 関係会社
- 複数会社
- 会社区分
...
- 人間がアナログで行っていた業務
- AI化したい業務
- システム化したい確認、分類、追跡、期限管理
- 総務AIに見せる前提
- プロンプトを育てるための方針
- 次に作るべき画面、DB、警告機能の材料

会社名や関係会社だけが入力された場合でも、「業務ルール適用対象外」と返してはいけない。
その場合は、関係会社・会社区分の業務ルールとして整理する。

人間がやっていたアナログ業務をAIとシステムに置き換える方針が入力された場合も、「対象外」としてはいけない。
その場合は、総務AIに見せる前提、会社ルール・注意点、AI化方針として整理する。

支払先、金額、証憑、支払日が不足している場合は、
「支払処理の確定対象外」ではあるが、
「業務フロー設定の対象外」ではない。

【分類例】
会社名・関係会社・複数会社・会社区分 → 関係会社・会社区分
AI化方針・アナログ業務の置き換え → 総務AIに見せる前提
書類なし支払・証憑後追い・銀行引落 → 支払書類、会社ルール・注意点
確認漏れ・期限超過・未回収 → 会社ルール・注意点、警告候補
