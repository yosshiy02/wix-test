...
const outPath = "G:\\GITHUB\\wix-test\\hd-origin-project\\GPTが使う一時ファイルフォルダ\\memo\\00_勘定科目_code_NULL化結果.txt";
...
async function main() {
  ...
  try {
    lines.push("==============================");
    lines.push("勘定科目 account_code NULL化結果");
    lines.push("==============================");
    ...
    lines.push("ID・科目名・表示順・使用中フラグは変更していません。");
  } catch (err) {
