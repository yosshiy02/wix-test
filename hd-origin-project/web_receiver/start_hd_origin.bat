...
echo WEB_DIR=%WEB_DIR%
echo PROJECT_DRIVE=%PROJECT_DRIVE%
echo RUNTIME_PATHS_FILE=%RUNTIME_PATHS_FILE%
echo PC_RULES_FILE=%PC_RULES_FILE%
echo DROPBOX_DRIVE=%DROPBOX_DRIVE%
echo DROPBOX_ROOT=%DROPBOX_ROOT%
...
echo PG_BIN_PATH=%PG_BIN_PATH%
echo BACKUP_DIR=%BACKUP_DIR%
echo BACKUP_KEEP_NORMAL=%BACKUP_KEEP_NORMAL%
echo BACKUP_KEEP_BEFORE_RESTORE=%BACKUP_KEEP_BEFORE_RESTORE%
echo PROJECT_BACKUP_KEEP=%PROJECT_BACKUP_KEEP%
echo NODE_PATH=%NODE_PATH%
echo NPM_PATH=%NPM_PATH%
echo CHROME_PATH=%CHROME_PATH%
