...
function buildPaymentDocumentDetailPrompt(ocrText, classification) {
  return [
    ...
    "",
    "Stage1結果の参照方法:",
    "- document_type_code はStage1で確定した書類種別です。",
    "- analysis_system_code はStage1で確定した専門解析先です。",
    "- analysis_system_confidence はStage1の信頼度です。",
    "- analysis_system_reason はStage1の判定理由です。",
    "- needs_review はStage1で要確認と判定されたかを示します。",
    "- warnings はStage1で発生した注意事項です。",
    "- 上記Stage1結果は確定済みの前提情報として必ず参照してください。",
    "- Stage2ではStage1結果を変更・再判定せず、この前提に沿ってOCR本文から基本情報だけを抽出してください。",
    "",
    "Stage1結果:",
    ...
    "- registrations is limited to public or registration identifiers: registration, qualified-invoice issuer registration, corporate, company-registration and reference numbers.",
    ...
    "- dates: labels and values for dates, year/month/day, datetimes, deadlines, or periods; preserve OCR value text exactly.",
    "- registrations: public or registration identifiers only; keep the exclusions above.",
    "",
    "Return JSON:",
    "{",
    '  "stage2_fields": {',
