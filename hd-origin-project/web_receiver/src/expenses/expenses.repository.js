...
async function getMasters() {
  ...
  return {
    ...
    contract_insurance_lease_kinds: contractInsuranceLeaseKinds.rows,
    insurance_types: insuranceTypes.rows,
    lease_item_categories: leaseItemCategories.rows,
    contract_types: contractTypes.rows,
    contract_statuses: contractStatuses.rows,
    payment_statuses: paymentStatuses.rows,
    payment_cycles: paymentCycles.rows,
