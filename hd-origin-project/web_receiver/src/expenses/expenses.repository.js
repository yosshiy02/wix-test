...
async function getMasters() {
  const [accountTitles, paymentMethods, taxCategories, vendors] = await Promise.all([
    pool.query(`
  ...
  try {
    ...
    const headerResult = await client.query(
      ...
      INSERT INTO expenses.expense_headers
        (expense_date, vendor_id, vendor_name, payment_method_id, payment_method_name, total_amount, summary)
      VALUES
        ($1, $2, $3, $4, $5, $6, $7)
      RETURNING *
      `,
